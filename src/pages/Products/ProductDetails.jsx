...
//                   isWishlisted
//                     ? "border-pink-400/30 bg-pink-500/20 text-pink-400 shadow-lg shadow-pink-950/20"
...
const ProductDetails = () => {
  ...
  const getProductImage = (item) => {
    if (
      ...
      return "https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=800&q=85";
    }
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <section className="grid grid-cols-1 gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
                ...
                {images.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-4 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-black/35 text-xl text-white/70 backdrop-blur-xl transition-all hover:scale-105 hover:border-violet-400/30 hover:bg-violet-500/20 hover:text-white"
                    >
                      ‹
                    </button>
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-black/35 text-xl text-white/70 backdrop-blur-xl transition-all hover:scale-105 hover:border-violet-400/30 hover:bg-violet-500/20 hover:text-white"
                    >
                      ›
                    </button>
                    ...
                    <div className="absolute bottom-5 left-1/2 -translate-x-1/2 rounded-full border border-white/10 bg-black/40 px-4 py-2 text-[11px] font-bold text-white/70 backdrop-blur-xl">
          ...
          <div className="flex flex-col justify-center">
            ...
            {stock > 0 && stock <= 5 && (
              <div className="mt-4 rounded-2xl border border-amber-400/15 bg-amber-500/10 px-4 py-3 text-xs font-bold text-amber-300">
        ...
        <section className="mt-20">
          <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link
              ...
              className="text-sm font-bold text-violet-300 transition-colors hover:text-white"
            >
              View All →
            </Link>
          </div>
          ...
          {isLoadingRelated ? (
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {[1, 2, 3, 4].map((item) => (
                <div
                  key={item}
                  className="h-[390px] animate-pulse rounded-[28px] border border-white/[0.06] bg-white/[0.025]"
                />
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {relatedProducts.map((item) => {
                const itemDiscount =
                  getRelatedDiscount(item);

                const itemPrice =
                  getRelatedPrice(item);
                ...
                return (
                  <Link
                    ...
                    className="group overflow-hidden rounded-[28px] border border-white/[0.07] bg-white/[0.025] backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:border-violet-400/20 hover:bg-white/[0.04]"
                  >
                    {/* IMAGE */}

                    <div className="relative h-64 overflow-hidden bg-gradient-to-br from-white/[0.04] to-violet-950/20">
                      <img
                      ...
                      {itemDiscount > 0 && (
                        <span className="absolute left-4 top-4 rounded-full border border-violet-300/20 bg-violet-600/90 px-3 py-1.5 text-[10px] font-black text-white">
                          {itemDiscount}% OFF
                        </span>
                      )}

                      {itemStock <= 0 && (
                        <span className="absolute right-4 top-4 rounded-full border border-red-400/20 bg-red-500/20 px-3 py-1.5 text-[10px] font-black text-red-300">
                          OUT OF STOCK
                        </span>
                      )}
                    </div>
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="mt-2 line-clamp-2 min-h-[48px] text-base font-black text-white transition-colors group-hover:text-violet-300">
                        {item.name}
                      </h3>
                      ...
                      <div className="mt-4 flex items-center justify-between border-t border-white/[0.06] pt-4">
                        ...
                        <span className="text-xs font-bold text-violet-300 transition-transform duration-300 group-hover:translate-x-1">
                          View →
                        </span>
                      </div>
                    </div>
