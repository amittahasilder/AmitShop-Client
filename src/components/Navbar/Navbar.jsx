...
//   // Keep search box synchronized with URL when user is on
//   // /products?search=...
//   useEffect(() => {
...
//       }
//     } catch (error) {
//       console.error("Navbar Count Error:", error);
//     }
//   };
...
//         className="
//           fixed left-0 right-0 top-0 z-[70]
//           hidden h-8 border-b border-violet-500/10
//           bg-[#05020b]/90 backdrop-blur-2xl md:block
//         "
//       >
//         <div
//           className="
...
//         className="
//           fixed left-0 right-0 top-0 z-50
//           px-3 pt-3 md:top-8 md:px-6 md:pt-4 lg:px-8
//         "
//       >
//         <nav
//           className="
//             group/nav relative mx-auto max-w-7xl
...
//           <div
//             className="
//               pointer-events-none absolute left-[5%] right-[5%]
//               top-0 h-px overflow-hidden
//               bg-gradient-to-r from-transparent
//               via-violet-400/80 to-transparent
//             "
//           >
//             <div
//               className="
...
//               justify-between px-4 sm:px-5 lg:px-6
//             "
//           >
//             {/* LOGO */}
...
//                     absolute inset-0
//                     bg-gradient-to-br
//                     from-white/25 via-transparent to-black/25
//                   "
//                 />
...
//                 <span
//                   className="
//                     relative text-xl font-black text-white
//                     drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]
//                   "
//                 >
//                   A
...
//               <div className="hidden sm:block">
//                 <div className="text-[21px] font-black leading-none tracking-tight text-white">
//                   Amit
//                   <span
//                     className="
//                       bg-gradient-to-r from-violet-400
//                       via-purple-400 to-fuchsia-400
...
//                     tracking-[0.3em] text-violet-300/45
//                   "
//                 >
//                   Shop Smart • Live Better
//                 </div>
...
//                       w-72 -translate-x-1/2 rounded-2xl
//                       border border-violet-400/20
//                       bg-gradient-to-br
//                       from-[#16082b]/98 via-[#0b0615]/98 to-[#180820]/98
//                       p-2 shadow-[0_30px_90px_rgba(0,0,0,0.65)]
//                       backdrop-blur-3xl
//                     "
//                   >
//                     <div
//                       className="
//                         mb-1 px-3 py-2 text-[9px] font-bold
...
//                     {[
//                       ["🛍️", "All Products", "Explore everything", "/products"],
//                       ["✨", "New Arrivals", "Latest products", "/products?sort=newest"],
//                       ["⭐", "Featured", "Our top picks", "/products?featured=true"],
//                     ].map(([icon, title, subtitle, path]) => (
//                       <Link
//                         key={title}
//                         to={path}
//                         onClick={closeMenus}
...
//                           hover:translate-x-1 hover:bg-violet-500/10
//                         "
//                       >
//                         <span
//                           className="
...
//                               transition-colors group-hover/item:text-white
//                             "
//                           >
//                             {title}
//                           </span>
...
//                     px-1.5 py-0.5 text-[7px] font-black text-white
//                     shadow-[0_0_15px_rgba(217,70,239,0.55)]
//                     animate-pulse
//                   "
//                 >
...
//                     className="
//                       absolute left-1/2 top-[calc(100%+14px)]
//                       w-[360px] -translate-x-1/2 rounded-2xl
//                       border border-violet-400/20
//                       bg-gradient-to-br
//                       from-[#16082b]/98 via-[#0b0615]/98 to-[#180820]/98
//                       p-3 shadow-[0_30px_90px_rgba(0,0,0,0.65)]
//                       backdrop-blur-3xl
//                     "
//                   >
//                     <div
//                       className="
//                         mb-3 px-2 text-[9px] font-bold uppercase
//                         tracking-[0.25em] text-violet-400/60
//                       "
//                     >
//                       Shop Categories
//                     </div>
...
//                     <div className="grid grid-cols-2 gap-1">
//                       {categories.map(([icon, name, subtitle]) => (
//                         <Link
//                           key={name}
//                           to={`/products?category=${name.toLowerCase()}`}
//                           onClick={closeMenus}
//                           className="
//                             group/category rounded-xl p-3
//                             transition-all duration-300
//                             hover:bg-violet-500/10
//                             hover:-translate-y-0.5
//                           "
...
//                     rounded-xl border border-violet-400/25
//                     bg-violet-500/10 p-1
...
//                       text-violet-200 transition-all
...
//                 onClick={closeMenus}
//                 className="
//                   group/icon relative flex h-10 w-10
//                   items-center justify-center rounded-xl
//                   text-white/50 transition-all duration-300
//                   hover:-translate-y-0.5
...
//                 "
//               >
//                 <span className="text-[19px] transition-transform duration-300 group-hover/icon:scale-110">
//                   ♡
//                 </span>
...
//                 "
//               >
//                 <span className="text-[18px] transition-transform duration-300 group-hover/icon:scale-110">
//                   🛒
//                 </span>
...
//                   via-violet-400/20 to-transparent
//                 "
//               />
...
//                 className="
//                   group/theme relative flex h-10 w-10
//                   items-center justify-center overflow-hidden
//                   rounded-xl border border-violet-400/15
//                   bg-gradient-to-br
//                   from-violet-500/10 to-fuchsia-500/5
//                   text-violet-300 transition-all duration-300
//                   hover:scale-105 hover:border-violet-400/35
//                   hover:shadow-[0_0_30px_rgba(139,92,246,0.25)]
//                 "
//               >
//                 <span
...
//                       rounded-xl border border-violet-400/20
//                       bg-gradient-to-r
//                       from-violet-600/15 via-purple-600/10
//                       to-fuchsia-600/10 px-3 py-2
...
//                           text-sm font-semibold text-white/70
//                           transition-all duration-300
//                           hover:translate-x-1 hover:bg-pink-500/10
//                           hover:text-white
//                         "
//                       >
//                         <span>♡</span>
...
//                           text-sm font-semibold text-red-300/80
//                           transition-all duration-300
//                           hover:translate-x-1 hover:bg-red-500/10
//                           hover:text-red-200
//                         "
//                       >
//                         <span>↪</span>
...
//                   to="/login"
//                   className="
//                     group/login ml-1 flex items-center gap-2
//                     rounded-xl border border-violet-400/20
//                     bg-gradient-to-r
...
//                 transition-all duration-300
//                 hover:scale-105 hover:border-violet-400/30
//                 hover:bg-violet-500/20 md:hidden
//               "
//             >
...
//                 "
//               >
//                 <span className="px-1 text-violet-300">⌕</span>
...
//                           : "text-white/55 hover:translate-x-1 hover:bg-white/[0.04] hover:text-white"
//                       }
//                     `}
//                   >
//                     {name}
...
//                     bg-white/[0.03] py-3
//                     text-xs font-semibold text-pink-200
//                     transition-all duration-300
//                     hover:-translate-y-0.5 hover:bg-pink-500/10
//                   "
//                 >
//                   ♡
//                   <span>Wishlist</span>
...
//                     transition-all duration-300
//                     hover:-translate-y-0.5 hover:bg-violet-500/10
//                   "
//                 >
//                   🛒
//                   <span>Cart</span>
...
//               h-px w-1/3 -translate-x-1/2
//               bg-gradient-to-r from-transparent
//               via-violet-400/70 to-transparent blur-sm
//             "
//           />
//         </nav>
//       </header>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="hidden sm:block">
                ...
                <div className="mt-1 text-[8px] font-bold uppercase tracking-[0.3em] text-violet-300/45">
                  Shop Smart • Live Better
                </div>
              </div>
            </Link>
              ...
              <div className="relative">
                ...
                {productsOpen && (
                  <div
                    ...
                    "
                  >
                    <div className="mb-1 px-3 py-2 text-[9px] font-bold uppercase tracking-[0.25em] text-violet-400/60">
                      Explore Products
                    </div>
              ...
              <div className="relative">
                ...
                {categoriesOpen && (
                  <div
                    ...
                    "
                  >
                    <div className="mb-3 px-2 text-[9px] font-bold uppercase tracking-[0.25em] text-violet-400/60">
                      Shop Categories
                    </div>
            ...
            <div className="hidden items-center gap-1 md:flex">
              ...
              <Link
                ...
                "
              >
                <span className="text-[19px] group-hover/icon:scale-110">
                  ♡
                </span>
              ...
              <Link
                ...
                "
              >
                <span className="text-[18px] group-hover/icon:scale-110">
                  🛒
                </span>
              ...
              <div className="mx-1 h-7 w-px bg-violet-400/20" />
                  ...
                  >
                    <span
                      className="
                        ...
                        justify-center rounded-lg
                        bg-gradient-to-br
                        from-violet-500 via-purple-600
                        to-fuchsia-600
                        text-xs font-black text-white
                      "
                    >
                    ...
                    >
                      ...
                      <Link
                        ...
                        className="
                          ...
                          text-white/70 hover:bg-violet-500/10
                          hover:text-white
                        "
                      >
                        ◉ My Profile
                      ...
                      <Link
                        ...
                        className="
                          flex items-center gap-3 rounded-xl
                          p-3 text-sm font-semibold
                          text-white/70 hover:bg-pink-500/10
                          hover:text-white
                        "
                      >
                        ♡ Wishlist
          ...
          <div
            ...
            `}
          >
            <div className="border-t border-violet-400/10 px-4 pb-5 pt-4">
              {/* SEARCH */}
              ...
              <form
                ...
                "
              >
                <span className="px-1 text-violet-300">
                  ⌕
                </span>
              ...
              <div className="flex flex-col gap-1">
                {mobileItems.map(([icon, name, path]) => (
                  <NavLink
                    key={path}
                    to={path}
                    onClick={closeMenus}
